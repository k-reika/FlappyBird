...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if  (contact.bodyA.categoryBitMask & scoreCategory) == scoreCategory || (contact.bodyB.categoryBitMask & scoreCategory) == scoreCategory {
            ...
            // item取得音
            let itemSound = SKAction.playSoundFileNamed("coin01.mp3", waitForCompletion: true)
    ...
    func setupBird(){
        ...
        let texuresAnmation = SKAction.animate(with: [birdTextureA,birdTextureB], timePerFrame: 0.2)
        let flap = SKAction.repeatForever(texuresAnmation)
